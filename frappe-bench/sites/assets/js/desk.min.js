	...
	*/
	...
	frappe.request.cleanup = function(opts, r) {
		...
		if(r) {
			...
			if (r.exc_type) {
				var handlers = frappe.request.error_handlers[r.exc_type] || [];
			...
			if(r._server_messages && !opts.silent) {
				var handlers$1 = frappe.request.error_handlers[r.exc_type] || [];
				// dont show server messages if their handlers exist
				if (!handlers$1.length) {
	...
	__vue_render__._withStripped = true;
	  ...
	  function __vue_normalize__(
	    ...
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/FilePreview.vue";
	...
	__vue_render__$1._withStripped = true;
	  ...
	  function __vue_normalize__$1(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/TreeNode.vue";
	...
	__vue_render__$2._withStripped = true;
	  ...
	  function __vue_normalize__$2(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/FileBrowser.vue";
	...
	__vue_render__$3._withStripped = true;
	  ...
	  var __vue_inject_styles__$3 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-114a63d0_0", { source: "\n.file-web-link .input-group {\n\tmargin-top: 10px;\n}\n", map: {"version":3,"sources":["/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/WebLink.vue"],"names":[],"mappings":";AAgCA;CACA,gBAAA;AACA","file":"WebLink.vue","sourcesContent":["<template>\n\t<div class=\"file-web-link margin-bottom\">\n\t\t<a href class=\"text-muted text-medium\"\n\t\t\t@click.prevent=\"$emit('hide-web-link')\"\n\t\t>\n\t\t\t{{ __('← Back to upload files') }}\n\t\t</a>\n\t\t<div class=\"input-group\">\n\t\t\t<div class=\"input-group-addon\">\n\t\t\t\t<span class=\"text-muted text-medium\">{{ __('Web Link') }}</span>\n\t\t\t</div>\n\t\t\t<input\n\t\t\t\ttype=\"text\"\n\t\t\t\tclass=\"form-control\"\n\t\t\t\t:placeholder=\"__('Attach a web link')\"\n\t\t\t\tv-model=\"url\"\n\t\t\t>\n\t\t</div>\n\t</div>\n</template>\n<script>\nexport default {\n\tname: 'WebLink',\n\tdata() {\n\t\treturn {\n\t\t\turl: '',\n\t\t}\n\t}\n}\n</script>\n\n<style>\n.file-web-link .input-group {\n\tmargin-top: 10px;\n}\n</style>\n"]}, media: undefined });
	  ...
	  function __vue_normalize__$3(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/WebLink.vue";
	...
	__vue_render__$4._withStripped = true;
	  ...
	  function __vue_normalize__$4(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/FileUploader.vue";
	...
	__vue_render__$5._withStripped = true;
	  ...
	  function __vue_normalize__$5(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/Popover.vue";
	...
	__vue_render__$6._withStripped = true;
	  ...
	  function __vue_normalize__$6(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/Dropdown.vue";
	...
	__vue_render__$7._withStripped = true;
	  ...
	  function __vue_normalize__$7(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/DeskModuleBox.vue";
	...
	__vue_render__$8._withStripped = true;
	  ...
	  function __vue_normalize__$8(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/DeskSection.vue";
		...
		methods: {
			...
			show_hide_cards_dialog: function show_hide_cards_dialog() {
				...
				frappe.call('frappe.desk.moduleview.get_options_for_show_hide_cards')
					.then(function (r) {
						var module_options = r.message;
						var fields = this$1.module_categories.map(function (category) {
							var options = module_options.filter(function (m) { return m.category === category; });
							return {
								label: category,
								fieldname: category,
						...
						var d = new frappe.ui.Dialog({
							...
							primary_action: function (values) {
								...
								var loop = function () {
									...
									var old_modules = old_values[category] || [];
									var new_modules = values[category] || [];
	...
	__vue_render__$9._withStripped = true;
	  ...
	  function __vue_normalize__$9(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/Desktop.vue";
	...
	frappe.ui.EnergyPointsNotifications = class {
		...
		setup_energy_points_notifications() {
			...
			this.get_energy_points_list(this.max_length).then(function (user_points_list) {
				this$1.dropdown_items = user_points_list;
				this$1.render_energy_points_dropdown();
				this$1.setup_view_full_log();
				if (this$1.$dropdown_list.find('.unseen').length) {
		...
		bind_events() {
			...
			frappe.realtime.on('energy_points_notification', function () {
				this$1.$dropdown.find('.energy-points-notification').show();
				this$1.update_dropdown();
			});

			this.$dropdown.on('hide.bs.dropdown', function () {
				this$1.$notification_indicator.hide();
				this$1.$dropdown_list.find('.unseen').removeClass('unseen');
			});
		...
		update_dropdown() {
			...
			this.get_energy_points_list(1).then(function (r) {
				var new_item = r[0];
				this$1.dropdown_items.unshift(new_item);
				if (this$1.dropdown_items.length > this$1.max_length) {
					this$1.$dropdown_list.find('.recent-points-item').last().remove();
		...
		insert_into_dropdown() {
			...
			var new_item_date_range = this.get_date_range_title(new_item.creation);
			var current_date_range = this.get_date_range_title(this.dropdown_items[1].creation);
			if (current_date_range !== new_item_date_range) {
				var $date_range = $(("<li class=\"points-date-range text-muted\">" + new_item_date_range + "</li>"));
		...
		check_seen() {
			var unseen_logs = this.dropdown_items.filter(function (item) { return item.seen === 0; });
		...
		get_date_range_title(date) {
			...
			var prev_week = frappe.datetime.add_days(current_date, -7);
			var prev_month = frappe.datetime.add_months(frappe.datetime.now_date(), -1);
		...
		get_energy_points_list(limit) {
			...
			}).then(function (energy_points_list) {
		...
		render_energy_points_dropdown() {
			...
			if (this.dropdown_items.length) {
				var date_range = this.get_date_range_title(this.dropdown_items[0].creation);
				body_html += "<li class=\"points-date-range text-muted\">" + date_range + "</li>";
				this.dropdown_items.forEach(function (field) {
					var current_field_date_range = this$1.get_date_range_title(field.creation);
			...
			var dropdown_html = header_html + body_html + view_full_log_html;
			this.$dropdown_list.html(dropdown_html);
		}

		get_dropdown_item_html(field) {
			var doc_link = frappe.utils.get_form_link(field.reference_doctype, field.reference_name);
			var link_html_string = field.seen ? ("<a href=" + doc_link + ">"): ("<a href=" + doc_link + " class=\"unseen\">");
			var points_html = "<div class=\"points-update\">" + (frappe.energy_points.get_points(field.points)) + "</div>";
			var message_html = this.get_message_html(field);

			var item_html = "<li class=\"recent-points-item\">\n\t\t\t" + link_html_string + "\n\t\t\t" + points_html + "\n\t\t\t<div class=\"points-reason\">\n\t\t\t\t" + message_html + "\n\t\t\t</div>\n\t\t\t</a>\n\t\t</li>";
			return item_html;
		}

		get_message_html(field) {
			var owner_name = frappe.user.full_name(field.owner).trim();
		...
		setup_view_full_log() {
			this.$dropdown_list.find('.full-log-btn').on('click', function () {
