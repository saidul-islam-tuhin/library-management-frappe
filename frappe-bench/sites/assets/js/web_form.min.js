(function () {
	...
	class WebFormList {
		...
		make_actions() {
			...
			addButton(actions, "delete-rows", "danger", true, "Delete", function () { return this$1.delete_rows(); }
			);
			...
			if (!(this.rows.length < this.page_length)) {
				addButton(footer, "more", "secondary", false, "More", function () { return this$1.more(); });
			}
	...
	class WebForm extends frappe.ui.FieldGroup {
		...
		setup_delete_button() {
			...
			this.add_button_to_header("Delete", "danger", function () { return this$1.delete(); });
		}
		...
		get_values(ignore_errors) {
			var values = super.get_values(ignore_errors);
		...
		save() {
			...
			var data = this.get_values(this.allow_incomplete);
		...
		handle_success(data) {
			...
			var success_dialog = new frappe.ui.Dialog({
				...
				secondary_action: function () {
					if (this$1.login_required) {
						if (this$1.route_to_success_link) {
							window.location.pathname = this$1.success_url;
						} else {
