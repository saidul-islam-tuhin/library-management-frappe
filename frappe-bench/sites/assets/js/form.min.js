(function () {
	...
	// ignored /home/tuhin/programs/library-management-frappe/frappe-bench/apps/frappe/frappe/public/js/frappe/form/controls/quill-mention/quill.mention.css
		...
		make_sortable($rows) {
			...
			new Sortable($rows.get(0), {
				...
				onUpdate: function (event) {
					...
					this$1.frm.script_manager.trigger(this$1.df.fieldnathis + "_move", this$1.df.options, doc.nathis);
					this$1.refresh();
					this$1.frm.dirty();
				}
			});
		...
		show_jump_to_field_dialog: function show_jump_to_field_dialog() {
			...
			var dialog = new frappe.ui.Dialog({
				...
				primary_action: function (ref) {
					...
					dialog.hide();
					var field = this$1.frm.get_field(fieldname);
					if (!field) { return; }
		...
		make() {
			...
			this.comment_area = frappe.ui.form.make_control({
				...
				on_submit: function (val) {
					strip_html(val) && this$1.insert_comment(val, this$1.comment_area.button);
				}
			});
