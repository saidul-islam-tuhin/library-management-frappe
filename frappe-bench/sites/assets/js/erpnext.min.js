	...
	*/
	...
	erpnext.TransactionController = erpnext.taxes_and_totals.extend({
						...
						callback: function(r) {
							if(!r.exc) {
								frappe.run_serially([
									...
									function () { return me.validate_pricing_rule(item); }
								]);
							}
						}
					});
		...
		validate_pricing_rule: function(item) {
			var me = this;
			var fields = ["discount_percentage", "discount_amount", "pricing_rules"];
	...
	erpnext.doctypes_with_dimensions.forEach(function (doctype) {
	...
	erpnext.child_docs.forEach(function (doctype) {
		frappe.ui.form.on(doctype, {
			items_add: function(frm, cdt, cdn) {
				erpnext.dimension_filters.forEach(function (dimension) {
