(function () {
	...
	class FilterArea {
		...
		make_standard_filters() {
			...
			fields = fields.concat(doctype_fields.filter(
				function (df) { return df.in_standard_filter &&
	...
	frappe.views.ListView = class ListView extends frappe.views.BaseList {
		...
		get_column_html(col, doc) {
			...
			var formatters = this.settings.formatters;
			...
			var field_html = function () {
				var html;
				var _value = typeof value === 'string' ? frappe.utils.escape_html(value) : value;
	...
	frappe.views.FileView = class FileView extends frappe.views.ListView {
		...
		get_left_html(file) {
			...
			var file_size = frappe.form.formatters.FileSize(file.file_size);
